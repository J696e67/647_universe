...
en: {
  ...
  'cer.seed.1.claim': 'White powder is lethal.',
  'cer.seed.1.evidence': 'Alice tasted the white powder and collapsed (Death Record #1).',
  'cer.seed.1.reasoning': 'Tasting the powder was Alice\'s last action before death. The powder had a distinct bitter-almond scent consistent with a known toxic substance. Ingestion triggered a lethal reaction.',
  'cer.seed.2.claim': 'The red berry is safe to eat.',
  'cer.seed.2.evidence': 'Tylor ate the red berry with clean hands and survived.',
  'cer.seed.3.evidence': 'Tylor ate the red berry and survived. Bob touched white powder, then ate the red berry, and collapsed.',
...
zh: {
  ...
  'cer.seed.1.claim': '\u767D\u8272\u7C89\u672B\u662F\u81F4\u547D\u7684\u3002',
  'cer.seed.1.evidence': 'Alice \u5C1D\u4E86\u767D\u8272\u7C89\u672B\u540E\u5012\u4E0B\u4E86\uFF08\u6B7B\u4EA1\u8BB0\u5F55 #1\uFF09\u3002',
  'cer.seed.1.reasoning': '\u5C1D\u7C89\u672B\u662F Alice \u6B7B\u524D\u7684\u6700\u540E\u52A8\u4F5C\u3002\u7C89\u672B\u6709\u660E\u663E\u7684\u82E6\u674F\u4EC1\u5473\uFF0C\u4E0E\u5DF2\u77E5\u6709\u6BD2\u7269\u8D28\u7279\u5F81\u4E00\u81F4\u3002\u4E0B\u80BA\u4E0B\u53BB\u89E6\u53D1\u4E86\u81F4\u547D\u53CD\u5E94\u3002',
  'cer.seed.2.claim': '\u7EA2\u679C\u662F\u5B89\u5168\u7684\uFF0C\u53EF\u4EE5\u5403\u3002',
  'cer.seed.2.evidence': 'Tylor \u7528\u6E05\u6D01\u7684\u624B\u5403\u4E86\u7EA2\u679C\uFF0C\u5B89\u7136\u65E0\u6059\u3002',
  'cer.seed.3.evidence': 'Tylor \u5403\u4E86\u7EA2\u679C\u6D3B\u4E86\u4E0B\u6765\u3002Bob \u5148\u89E6\u4E86\u767D\u8272\u7C89\u672B\uFF0C\u518D\u5403\u4E86\u7EA2\u679C\uFF0C\u7136\u540E\u5012\u4E0B\u4E86\u3002',
  // Claim titles
